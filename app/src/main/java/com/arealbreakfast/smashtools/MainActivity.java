...
public class MainActivity extends AppCompatActivity
    ...
    public void Smash4IM(View view) {
        Intent intent = new Intent(view.getContext(), SmashFourIronMan.class);
        startActivity(intent);
    }

    public void MeleeIM(View view) {
        Intent intent = new Intent(view.getContext(), MeleeIronMan.class);
        startActivity(intent);
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_smash4IM) {
            Intent intent = new Intent(this, SmashFourIronMan.class);
            startActivity(intent);
